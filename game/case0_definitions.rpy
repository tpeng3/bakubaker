...
init python:
    # PART ONE
    t_marcella_start = Interactables("Marcella Lapin", "images/interactables/case0/rabbitOne.png", page=0,
        actions = [
            {"name": "Talk to Marcella", "label": "marcella_talk_start"}
        ]
    )
    t_bunnysquad = Interactables("Fluffle of Bunnies", "images/interactables/case0/strawberry.png", page=0,
        actions = [
            {"name": "Talk with Bunnies (Somnia)", "label": "bunnies_talk_som"},
            {"name": "Talk with Bunnies (Remerie)", "label": "bunnies_talk_rem"}
        ]
    )
    t_strawberry = Interactables("Giant Strawberry", "images/interactables/case0/strawberry.png", page=0,
        actions = [
    ...
    # PART TWO 
    t_marcella_mid = Interactables("Marcella Lapin", "images/interactables/case0/rabbitOne.png", page=1,
        actions = [
    ...
    t_report = Interactables("Report", "images/interactables/case0/rabbitOne.png", page=0,
        actions = [
            {"name": "Find Report", "label": "report_find"}
        ]
    )
    t_report = Interactables("Bottle of Medicine", "images/interactables/case0/rabbitOne.png", page=1,
        actions = [
            {"name": "Find Medicine", "label": "medicine_find"}
        ]
    )
    t_debris = Interactables("Mounds of Papers", "images/interactables/case0/rabbitOne.png", page=1,
        actions = [
            {"name": "Inspect Pile", "label": "pile_inspect"}
        ]
    )
    t_bunny1 = Interactables("Quiet Bunny", "images/interactables/case0/rabbit.png", page=0,
        actions = [
    ...
    t_bunny2 = Interactables("Energetic Bunny", "images/interactables/case0/rabbit.png", page=0,
        actions = [
    ...
    t_bunny3 = Interactables("Peevish Bunny", "images/interactables/case0/rabbit.png", page=1,
        actions = [
    ...
    t_bunny4 = Interactables("Studious Bunny", "images/interactables/case0/rabbit.png", page=1,
        actions = [
    ...
    t_bunny5 = Interactables("Clumsy Bunny", "images/interactables/case0/rabbit.png", page=1,
        actions = [
    ...
    t_flower1 = Interactables("White Rose", "images/interactables/case0/rabbit.png", page=0,
        actions = [
            {"name": "Paint the Rose", "label": "flower1_paint"}
        ]
    )
    t_flower2 = Interactables("White Rose", "images/interactables/case0/rabbit.png", page=0,
        actions = [
            {"name": "Paint the Rose", "label": "flower2_paint"}
        ]
    )
    t_flower3 = Interactables("White Rose", "images/interactables/case0/rabbit.png", page=0,
        actions = [
            {"name": "Paint the Rose", "label": "flower3_paint"}
        ]
    )
    t_flower4 = Interactables("White Rose", "images/interactables/case0/rabbit.png", page=1,
        actions = [
            {"name": "Paint the Rose", "label": "flower4_paint"}
        ]
    )
    t_flower5 = Interactables("White Rose", "images/interactables/case0/rabbit.png", page=1,
        actions = [
            {"name": "Paint the Rose", "label": "flower5_paint"}
        ]
    )
    t_flower6 = Interactables("White Rose", "images/interactables/case0/rabbit.png", page=1,
        actions = [
            {"name": "Paint the Rose", "label": "flower6_paint"}
        ]
    )
    t_flower7 = Interactables("White Rose", "images/interactables/case0/rabbit.png", page=1,
        actions = [
    ...
    # PART THREE
    t_marcella_end = Interactables("Marcella Lapin", "images/interactables/case0/rabbitOne.png", page=2,
        actions = [
    ...
    t_clockface1 = Interactables("Clock", "images/interactables/case0/rabbitOne.png", page=0,
        actions = [
    ...
    t_clockface2 = Interactables("Clock", "images/interactables/case0/rabbitOne.png", page=1,
        actions = [
    ...
    t_clockface3 = Interactables("Clock", "images/interactables/case0/rabbitOne.png", page=2,
        actions = [
    ...
    t_clockface4 = Interactables("Clock", "images/interactables/case0/rabbitOne.png", page=2,
        actions = [
